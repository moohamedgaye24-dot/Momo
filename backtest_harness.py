...
class BacktestHarness:
    ...
    def run_autoresearch_loop(self):
        ...
        results = self.walk_forward_analysis(data)
        self.generate_learnings()
        weights = self.apply_meta_learning()

        # Send Telegram Summary
        total_pnl = self.balance - self.initial_balance
        evo_summary = f"Meta-Learning Weight Adjustments: {weights}"
        self.telegram.notify_midnight_summary(total_pnl, evo_summary)
